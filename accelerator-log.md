...
```json
{
  "projectName" : "tanzu-java-web-app-mduser031",
  "repositoryPrefix" : "https://harbor-tap.livefire.lab/mduser031"
}
```
## Log
```
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->https://harbor-tap.l...(truncated)]
